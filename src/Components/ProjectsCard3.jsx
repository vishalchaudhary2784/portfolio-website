...
import bannerImg from "../assets/law.jpeg";


const ProjectsCard3 = ({ title, main }) => {
    return (
        <div className='p-3 md:p-6 flex flex-col w-80 bg-[#0c0e19] shadow-lg shadow-slate-900 rounded-2xl'>
            ...
            <h1 className="font-bold">Advocate :- AMITA CHAUDHARY</h1>
            <h1 className="font-bold">Contact No :- 7770088888</h1>
