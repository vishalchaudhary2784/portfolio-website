...
import bannerImg from "../assets/law-3.jpeg";


const ProjectsCard2 = ({ title, main }) => {
  return (
    <div className='p-3 md:p-6 flex flex-col w-80 bg-[#0c0e19] shadow-lg shadow-slate-900 rounded-2xl'>
        ...
        <h1 className="font-bold">Advocate :- KHUSHI JANGRA</h1>
        <h1 className="font-bold">Contact No :- 9999988888</h1>
